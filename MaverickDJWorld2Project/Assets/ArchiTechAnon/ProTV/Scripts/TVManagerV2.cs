...
namespace ArchiTech
{
    ...
    public class TVManagerV2 : UdonSharpBehaviour
    {
        ...
        //
        [Tooltip("The volume that the TV starts off at.")] [Range(0f, 1f)]
        ...
        public override bool OnOwnershipRequest(VRCPlayerApi requestingPlayer, VRCPlayerApi requestedOwner)
        {
            ...
            return !locked || isPrivilegedUser(requestingPlayer);
        }
        ...
        public void _OnVideoPlayerReady()
        {
            ...
            else if (bufferDelayAfterLoad > 0)
            {
                ...
                queueSync(bufferDelayAfterLoad + 1f);
            }
            else
            {
                prepareMedia();
        ...
        public bool _IsPrivilegedUser()
        {
            ...
            if (hasLocalPlayer) return isPrivilegedUser(localPlayer);
            log("No local player available.");
            return false;
        }

        private bool isPrivilegedUser(VRCPlayerApi p)
        {
